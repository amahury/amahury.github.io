...
math: false
mermaid: false
description: An excellent opportunity for those planning to remain in academia after their postdoctoral fellowship.
alpez:
  name: Amahury J. L. Diaz
  twitter: amahury0
---
### Job description
The candidate will join the section Network Architectures and Services (NAS), see https://www.nas.ewi.tudelft.nl. The candidate for this position has expertise in the broad area of Network Science. Network Science is the theory of dynamic processes (services, functions, software) on a graphs (topology, structure, hardware). A special focus for this position lies on network resilience, the network’s capability to withstand, adapt to and recover from external disruptions during a given time interval. Disruptions include topological disruptions, like failures or attacks of a subset of nodes or links, but also service perturbations (i.e. smaller bandwidth, more packet loss/delay in telecom nets and voltage/current drops or spikes in power grids, etc).
...
If you would like more information about this vacancy or the selection procedure, please contact Prof. dr. ir. P. Van Mieghem, via P.F.A.VanMieghem@tudelft.nl with cc to Bernd Tuithof (B.C.M.Tuithof@tudelft.nl). When inquiring about this position, please refer to vacancy number EWI2026-NASUD. 
...
Source and more details: [https://careers.tudelft.nl/job/Delft-Assistant-Professor-on-Network-Science-2628-CD/1362781557/](https://careers.tudelft.nl/job/Delft-Assistant-Professor-on-Network-Science-2628-CD/1362781557/)
